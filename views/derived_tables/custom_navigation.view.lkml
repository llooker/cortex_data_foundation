view: custom_navigation_buttons {
  ...
  measure: dash_nav {
    ...
    <a style="padding: 5px; float: center; line-height: 40px; margin-left: 8px; color: #4285F4" href="/dashboards-next/42">Product Snapshot</a>
    <a style="padding: 5px; float: center; line-height: 40px; margin-left: 8px; color: #4285F4" href="/dashboards-next/44">Customer Snapshot</a>
    <a style="padding: 5px; float: center; line-height: 40px; margin-left: 8px; color: #4285F4" href="/dashboards-next/45">Orders Snapshot</a>
    </nav>
    </div>
    <div style="background-color: #FFFFFF; height:500px;width:100%"></div>;;
  }
