view: material_md {
  ...
  dimension: document_change_number__without_document_management_system___aeszn {
    type: string
    sql: ${TABLE}.DocumentChangeNumber__withoutDocumentManagementSystem___AESZN ;;
  }

  dimension: document_number__without_document_management_system___zeinr {
    type: string
    sql: ${TABLE}.DocumentNumber__withoutDocumentManagementSystem___ZEINR ;;
  }

  dimension: document_type__without_document_management_system___zeiar {
    type: string
    sql: ${TABLE}.DocumentType__withoutDocumentManagementSystem___ZEIAR ;;
  }

  dimension: document_version__without_document_management_system___zeivr {
    type: string
  ...
  dimension: maximum_level__by_volume___fuelg {
    type: number
  ...
  dimension: number_of_sheets__without_document_management_system___blanz {
    type: string
  ...
  dimension: page_format_of_document__without_document_management_system___zeifo {
    type: string
  ...
  dimension: page_number_of_document__without_document_management_system___blatt {
    type: string
  ...
  dimension: productioninspection_memo_ferth {
    type: string
  ...
  dimension: sizedimensions_groes {
    type: string
  ...
  dimension: unit_of_weight__allowed_packaging_weight___ergei {
    type: string
  ...
  dimension: variant_price_allowed__for_material_master___allow_pmat_igno {
    type: string
    sql: ${TABLE}.VariantPriceAllowed__forMaterialMaster___ALLOW_PMAT_IGNO ;;
  }

  dimension: volume_unit__allowed_packaging_volume___ervoe {
    type: string
