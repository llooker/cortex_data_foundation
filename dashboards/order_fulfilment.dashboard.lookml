- dashboard: orders_fulfilment
  ...
  - title: Top 20 Delayed Materials
    ...
    type: looker_column
    fields: [material_md.material_number, uom_md.unit_of_measurement_text_maximum10_characters,
      stock_unrestricted_vs_sales.total_unrestricted_stock]
    filters:
  ...
  - title: Customers with Delayed Deliveries
    ...
    width: 12
    height: 9
  - title: Top 20 Pending Materials
    name: Top 20 Pending Materials
    model: sap_operational_reporting
    explore: sales_orders
    type: looker_column
  ...
  - title: Late Deliveries
    ...
    explore: sales_orders
    type: looker_grid
    fields: [sales_orders.sales_document, sales_orders.material_number, material_md.material_text,
      customers_md.customer_name, uom_md.unit_of_measurement_text_maximum10_characters,
      deliveries.delivery_delay, stock_unrestricted_vs_sales.plant_region, sales_orders.total_cumulative_order_quantity,
      sales_orders.total_sales_order_org_currency]
    filters:
      deliveries.delivery_delay: ">0"
